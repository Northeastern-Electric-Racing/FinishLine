...
import NERSuccessButton from '../../components/NERSuccessButton';
  ...
  export type WpCreateChangeRequestFormInput = ChangeRequestFormInput & WorkPackageFormViewPayload;

  interface WpCreateChangeRequestFormProps {
    onSubmit: (data: WpCreateChangeRequestFormInput) => void;
    open: boolean;
    onClose: () => void;
    projectEdits?: WorkPackageFormViewPayload;
  }
  ...
  const WpCreateChangeRequestForm: React.FC<WpCreateChangeRequestFormProps> = ({
    onSubmit,
    open,
    onClose,
    projectEdits
    ...
    const submitChangeRequest = (data: ChangeRequestFormInput) => {
      if (projectEdits) {
        const changeRequestPayload: WpCreateChangeRequestFormInput = {
          ...data,
          ...projectEdits
        };
    ...
    return (
      <Dialog open={open} onClose={onClose}>
        <DialogTitle>Create a Change Request From WP Edits</DialogTitle>
        <IconButton
          aria-label="close"
          onClick={onClose}
          sx={{
        ...
        >
          <form
            id={'wp-create-change-request-form'}
            onSubmit={(e) => {
              e.preventDefault();
              e.stopPropagation();
          ...
          >
            ...
            <Box display="flex" flexDirection="row-reverse">
              <NERSuccessButton
                ...
                variant="contained"
                type="submit"
                form="wp-create-change-request-form"
  ...
  export default WpCreateChangeRequestForm;