...
import { useGetRuleset, useGetTopLevelRules, useDeleteRule } from '../../hooks/rules.hooks';
...
const RulesetEditPage: React.FC = () => {
  ...
  const totalRulesToDelete = ruleToDelete ? countRulesToDelete(ruleToDelete, topLevelRules) : 0;
