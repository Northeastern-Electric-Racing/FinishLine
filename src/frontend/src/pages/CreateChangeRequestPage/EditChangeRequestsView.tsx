...
import { ChangeRequestFormReturn } from './EditChangeRequestModal';

interface EditChangeRequestsViewProps {
  wbsNum: string;
...
const EditChangeRequestsView: React.FC<EditChangeRequestsViewProps> = ({
  wbsNum,
  setWbsNum,
  onSubmit,
  proposedSolutions,
...
export default EditChangeRequestsView;
