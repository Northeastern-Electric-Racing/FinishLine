...
import ProjectAutoCRContainer from '../ProjectDetailPage/ProjectForm/ProjectAutoCRContainer';
...
const Projects: React.FC = () => {
  return (
    <Switch>
      ...
      <Route path={routes.PROJECTS_NEW_CR} component={ProjectAutoCRContainer} />
