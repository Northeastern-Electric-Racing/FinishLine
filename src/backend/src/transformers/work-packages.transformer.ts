...
const workPackageTransformer = (wpInput: Prisma.Work_PackageGetPayload<typeof workPackageQueryArgs>): WorkPackage => {
  ...
  return {
    ...
    projectManager: wpInput.wbsElement.manager ? userTransformer(wpInput.wbsElement.manager) : undefined,
    projectLead: wpInput.wbsElement.lead ? userTransformer(wpInput.wbsElement.lead) : undefined,
