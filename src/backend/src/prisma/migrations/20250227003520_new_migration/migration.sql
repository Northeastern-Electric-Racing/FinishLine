...
-- AlterTable
ALTER TABLE "_PartToPartTag" ADD CONSTRAINT "_PartToPartTag_AB_pkey" PRIMARY KEY ("A", "B");

-- DropIndex
DROP INDEX "_PartToPartTag_AB_unique";
...
-- AlterTable
ALTER TABLE "_checkedChecklists" ADD CONSTRAINT "_checkedChecklists_AB_pkey" PRIMARY KEY ("A", "B");

-- DropIndex
DROP INDEX "_checkedChecklists_AB_unique";
...
-- AlterTable
ALTER TABLE "_onboardedTeamTypes" ADD CONSTRAINT "_onboardedTeamTypes_AB_pkey" PRIMARY KEY ("A", "B");

-- DropIndex
DROP INDEX "_onboardedTeamTypes_AB_unique";

-- AlterTable
ALTER TABLE "_onboardingTeamTypes" ADD CONSTRAINT "_onboardingTeamTypes_AB_pkey" PRIMARY KEY ("A", "B");

-- DropIndex
DROP INDEX "_onboardingTeamTypes_AB_unique";
...
-- AlterTable
ALTER TABLE "_partAssignees" ADD CONSTRAINT "_partAssignees_AB_pkey" PRIMARY KEY ("A", "B");

-- DropIndex
DROP INDEX "_partAssignees_AB_unique";

-- AlterTable
ALTER TABLE "_partReviewers" ADD CONSTRAINT "_partReviewers_AB_pkey" PRIMARY KEY ("A", "B");

-- DropIndex
DROP INDEX "_partReviewers_AB_unique";
