...
export default class OnboardingServices {
   ...
   */
  static async getUsersTeamTypeChecklists(userId: string, organization: Organization) {
    ...
    console.log(teamTypeChecklists);
